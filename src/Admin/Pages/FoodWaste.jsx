...
export const FoodWaste = () => {
  ...
  const closeFoodModal = () => setShowFoodModal(false);
    ...
    useEffect(() => {
      ...
      AxiosInstance.get('/api/foodwaste/')
        .then(response => {
    ...
    const handleAccept = (id) => {
      AxiosInstance.post(`/api/foodwaste/approve`, { id })
        .then(response => {
        ...
        .catch(error => {
          console.error('Error approving foodwaste collection:', error);
        });
    };
  
    const handleDecline = (id) => {
      AxiosInstance.post(`/api/foodwaste/decline`, { id })
        .then(response => {
          // Update the egg data after the status change
          setFoodData(prevData => prevData.map(entry =>
        ...
        .catch(error => {
          console.error('Error declining foodwaste collection:', error);
        });
    };
    ...
    const refreshData = () => {
      AxiosInstance.get('/api/foodwaste/')
        ...
        .catch(error => {
          console.error('Error refreshing foodwaste data: ', error);
        });
    };

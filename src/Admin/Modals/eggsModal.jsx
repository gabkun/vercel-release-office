...
export const EggsModal = ({ isOpen, onClose, onSubmitSuccess, employees }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axiosInstance.post('/api/eggs/create', {
        ...formData,
      ...
      console.error('Failed to submit egg data:', error);
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div className="bg-white p-6 rounded-2xl shadow-xl w-full max-w-lg relative animate-fadeIn">
        ...
        <div className="flex items-center gap-3 mb-6">
          <FaEgg className="text-yellow-600 text-2xl" />
          <h2 className="text-xl font-semibold text-gray-800">Add Egg Collection</h2>
        </div>

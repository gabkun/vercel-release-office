...
export const PelletsModal = ({ isOpen, onClose, onSubmitSuccess, employees }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axiosInstance.post('/api/pellets/create', {
        ...formData,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div className="bg-white p-6 rounded-2xl shadow-xl w-full max-w-lg relative animate-fadeIn">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-semibold text-gray-800">Add Pellets Collection</h2>
        </div>
